#include "linux/c_tuntap_linux_obj.hpp"
...
int main() {
	std::array<unsigned char, IPV6_LEN> binary_address;
	binary_address.fill(1);
	binary_address.at(0) = 0xFC;
	binary_address.at(1) = 0x9D;
	tuntap.set_tun_parameters(binary_address, 16, 1500);
